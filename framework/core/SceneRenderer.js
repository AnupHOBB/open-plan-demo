...
export class SceneRenderer
{
    ...
    constructor(canvas, width, height)
    {
        ...
        this.pixelMergerPass = new MergerPass(this.sceneRenderComposer.readBuffer.texture, this.ssaoComposer.readBuffer.texture)
        ...
        this.finalComposer.addPass(new AdderPass(null, this.bloomComposer.readBuffer.texture, 1, 3))
